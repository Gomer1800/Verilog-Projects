...
HD_PWD='C:/Users/luisg/Desktop/Fall 2018/CPE 133/Verilog-Projects/lab5/exp9 BCD Comparator Display Module/exp9 BCD Comparator Display Module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exp9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exp9.tcl
