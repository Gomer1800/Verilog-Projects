...
HD_PWD='C:/Users/luisg/Desktop/Fall 2018/CPE 133/Verilog-Projects/lab5/exp9 BCD Comparator Display Module/exp9 BCD Comparator Display Module.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exp9.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exp9.tcl -notrace
