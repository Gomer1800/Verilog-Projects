...
HD_PWD='C:/Users/luisg/Desktop/Fall 2018/CPE 133/Verilog-Projects/lab7 FSM_Counter/exp 14 Sequence Detector FSM/exp 14 Sequence Detector FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_sequence_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_sequence_detector.tcl
