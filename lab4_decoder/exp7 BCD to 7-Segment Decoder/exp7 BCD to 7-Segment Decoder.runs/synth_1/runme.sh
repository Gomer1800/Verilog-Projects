...
HD_PWD='C:/Users/luisg/Desktop/Fall 2018/CPE 133/Verilog-Projects/lab4_decoder/exp7 BCD to 7-Segment Decoder/exp7 BCD to 7-Segment Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd7segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd7segment.tcl
