...
HD_PWD='C:/Users/luisg/Desktop/Fall 2018/CPE 133/Labs/lab2/reduced full adder/reduced full adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reducedFullAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reducedFullAdder.tcl -notrace
