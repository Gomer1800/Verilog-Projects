...
HD_PWD='C:/Users/luisg/Desktop/Fall 2018/CPE 133/Labs/lab2/reduced full adder/reduced full adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reducedFullAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reducedFullAdder.tcl
