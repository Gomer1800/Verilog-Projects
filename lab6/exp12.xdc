...
#set_property PACKAGE_PIN W14 [get_ports {SWA[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {SWA[6]}]
#set_property PACKAGE_PIN W13 [get_ports {SWA[7]}]					
...
set_property PACKAGE_PIN W19 [get_ports btnEn]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnEn]
set_property PACKAGE_PIN T17 [get_ports btnT]						
