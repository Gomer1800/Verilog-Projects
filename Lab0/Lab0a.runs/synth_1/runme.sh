...
HD_PWD='C:/Users/luisg/Desktop/Fall 2018/CPE 133/Labs/Lab0a/Lab0a.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sandwhich.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sandwhich.tcl
